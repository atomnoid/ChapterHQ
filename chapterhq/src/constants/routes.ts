...
export const PROTECTED_ROUTES = ["/dashboard", "/members", "/roles", "/organizations", "/committees", "/appointments", "/events", "/attendance", "/finance", "/inventory", "/certificates", "/notifications"] as const;
