...
import { FinanceList } from "@/features/finance/components/finance-list";

export const metadata: Metadata = {
  title: "Finance & Accounting — ChapterHQ",
  description: "View transaction ledgers, balance statements, income, and expenses.",
};
